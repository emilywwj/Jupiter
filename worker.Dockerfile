...
ADD app_specific_files/network_monitoring/configuration.txt DAG/DAG_application.txt
ADD app_specific_files/network_monitoring/input_node.txt DAG
ADD app_specific_files/network_monitoring/sample_input/1botnet.ipsum /1botnet.ipsum
