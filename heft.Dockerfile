...
RUN echo app_specific_files/network_monitoring
ADD app_specific_files/network_monitoring/configuration.txt  /heft/dag.txt
ADD app_specific_files/network_monitoring/scripts/config.json /heft/config.json
